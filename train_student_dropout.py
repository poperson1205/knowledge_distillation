...
# Create model
student_model = Student(use_dropout=True)
...
for epoch_count in range(3000):
    ...
    if epoch_count % 100 == 0:
        torch.save(student_model.state_dict(), './data/student-dropout-{}.pth'.format(epoch_count))


## Save model
torch.save(student_model.state_dict(), './data/student-dropout.pth')
